      ...
      <div class="fixed right-6 bottom-18 z-50 block">
        <div class="relative w-16 h-16 group cursor-pointer" @click="openWhatsApp">
          ...
          <div class="relative w-full h-full bg-green-500 rounded-full shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:scale-110 flex items-center justify-center">
            ...
            <div class="absolute top-0 right-0 w-3 h-3 bg-green-400 rounded-full border-2 border-white"></div>
          </div>
          
          <div class="absolute right-full mr-3 top-1/2 transform -translate-y-1/2 px-3 py-2 bg-white text-gray-800 text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
            আমাদের সাথে হোয়াটসঅ্যাপে যোগাযোগ করুন
            <div class="absolute left-full top-1/2 transform -translate-y-1/2 border-8 border-transparent border-l-gray-800"></div>
          </div>
        </div>
      </div>
    </NuxtLayout>
...
.group:hover > div:first-child > div:first-child {
