    ...
    <div class="bg-gray-800 py-10 md:py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          <div class="space-y-4">
            <img :src="data?.logo_light"
              class="w-18 h-auto md:w-18 lg:w-18 rounded-2xl object-cover justify-center items-center" alt="">
            ...
            <div class="flex space-x-4">
              <a :href="facebookLink"
                class="p-2 bg-gray-700 rounded-lg hover:bg-blue-600 transition-all duration-300 transform hover:scale-110"
                aria-label="Facebook Page">
                <Icon name="mdi:facebook" class="h-5 w-5 text-white" />
              </a>
              <a :href="whatsappLink"
                class="p-2 bg-gray-700 rounded-lg hover:bg-green-500 transition-all duration-300 transform hover:scale-110"
                aria-label="WhatsApp Contact">
                <Icon name="mdi:whatsapp" class="h-5 w-5 text-white" />
              </a>
              <a :href="`mailto:${email}`"
                class="p-2 bg-gray-700 rounded-lg hover:bg-red-500 transition-all duration-300 transform hover:scale-110"
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li>
                <RouterLink to="/about"
                  class="flex items-center text-gray-300 hover:text-yellow-300 transition-all duration-200 group">
                  <span
                    class="w-2 h-2 bg-yellow-400 rounded-full mr-3 group-hover:scale-150 transition-transform"></span>
                  আমাদের সম্পর্কে
                </RouterLink>
              </li>
              <li>
                <RouterLink to="/products/AllBooks"
                  class="flex items-center text-gray-300 hover:text-yellow-300 transition-all duration-200 group">
                  <span
                    class="w-2 h-2 bg-yellow-400 rounded-full mr-3 group-hover:scale-150 transition-transform"></span>
                  সকল বই
          ...
          <div>
            ...
            <div class="space-y-4">
              ...
              <a :href="`mailto:${email}`"
                class="flex items-center text-yellow-300 hover:text-yellow-200 transition-colors duration-200 group">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          <p class="text-sm text-gray-300">
            ...
            <a href="https://creativetechpark.com" target="_blank"
              class="text-yellow-400 hover:text-white transition-colors duration-200 font-semibold">
              Creative Tech Park
            </a>
          </p>
        </div>
