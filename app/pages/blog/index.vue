...
const { data: blogsData, error, status, refresh } = useAsyncData('blog', () => $api('/frontend/v1/blog'));
                ...
                <div class="flex flex-wrap -m-4">
                    <div v-for="blog in blogs" :key="blog.id" class="p-4 md:w-1/3">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            <img class="lg:h-48 md:h-36 w-full object-cover object-center" :src="blog.image_url"
                                alt="blog">
                            <div class="p-6">
